...
public class Bdd extends SQLiteOpenHelper{
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("INSERT INTO questions (question, id_the) values  (\"Qui a crée Android?\",2) ");
		db.execSQL("INSERT INTO questions (question, id_the) values  (\"Qui a racheté Android?\",2) ");
